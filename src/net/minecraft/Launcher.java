        ...
        implements Runnable, AppletStub, MouseListener
{
    ...
    public void paint(Graphics g2)
    {
        ...
        else
        {
            ...
            if (!gameUpdater.fatalError)
            {
                ...
                g.setColor(Color.black);
                g.fillRect(64, h - 50, w - 128 + 1, 5);
                g.setColor(new Color(32768));
                g.fillRect(64, h - 50, gameUpdater.subPercentage * (w - 128) / 100, 4);
                g.setColor(new Color(2138144));
                g.fillRect(65, h - 50 + 1, gameUpdater.subPercentage * (w - 128) / 100 - 2, 1);
            }
        }
    ...
    public URL getDocumentBase()
    {
        try
        {
            return new URL("http://www.minecraft-moscow.ru");
        }
