...
public class LoginForm extends TransparentPanel
{
    ...
    private JScrollPane getUpdateNews()
    {
        ...
        try
        {
            ...
            editorPane.setContentType("text/html; charset=cp1251");
            ...
            new Thread()
            {
                ...
                public void run()
                {
                    try
                    {
                        editorPane.setPage(new URL("http://www.minecraft-moscow.ru/news/index.php"));
                    }
                    catch (Exception e)
                    {
                        e.printStackTrace();
            ...
            else
            {
                ...
                accountLink.addMouseListener(new MouseAdapter()
                {
                    ...
                    public void mousePressed(MouseEvent arg0)
                    {
                        try
                        {
                            Util.openLink(new URL("http://www.minecraft-moscow.ru/login/").toURI());
                        }
                        catch (Exception e)
                        {
                            e.printStackTrace();
